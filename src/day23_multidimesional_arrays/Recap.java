package day23_multidimesional_arrays;
...
public class Recap {
    public static void main(String[] args) {
        ...
        //  how to print arrays / how to convert array to String (with square brackets and comas)
        ...
        String [] strArray = {"java", "selenium", "jira", "sprint", "release"};
        ...
        System.out.println(Arrays.toString(str4.toCharArray())); // charArray
